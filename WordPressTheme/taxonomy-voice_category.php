          ...
          <div class="sub-voice__inner inner">
            <div class="sub-voice__wrapper">
              <div class="sub-voice__tab tab">
                <a href="<?php echo esc_url(get_post_type_archive_link('voice')); ?>" class="tab__menu <?php if (is_post_type_archive('campaign') && !is_tax('campaign_category')) echo 'is-active'; ?>">ALL</a>
                <?php
                ...
                ?>
                  <a href="<?php echo esc_url(get_term_link($genre_term, 'voice_category')); ?>" class="tab__menu <?php echo esc_attr($is_active); ?>">
